...
[![Product Name Screen Shot][product-screenshot]](https://github.com/audrey-audrey/fetch_v2/blob/main/client/src/images/fetch.png)

This app was built as part of Lighthouse Labs' final project.
...
3. Open client folder and install NPM packages
   ...
   npm install
   ```
4. Open backend folder and install gems
   ```sh
   bundle install
   ```
