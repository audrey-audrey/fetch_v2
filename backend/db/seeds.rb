...
user2 = User.create!(
    ...
    bio: "Hi! We're looking forward to meeting other dogs in the neghbour. Extra points for pasta lovers!",
    playful: true,
    affectionate: true,
    high_energy: true,
    shy: false,
  ...
  user6 = User.create!(
    ...
    bio: "Welcome to Joey and Pugly's page! Pugly's an old guy who still loves getting lots of exercise. Contact us if you want to run around with us!",
    playful: true,
    affectionate: true,
    high_energy: false,
    shy: false,
